...
**둘. 부하가 라우터의 발송 수가 아니라 엔진의 큐다.** 원본은 자기가 보내고 아직 안 끝난 요청
수를 센다. 우리는 CMS에서 엔진 자신의 `NumWaitingRequests + NumRunningRequests`를 받는데,
**같은 양을 한 단계 더 가까이에서 잰 것**이고 어긋날 수 있는 완료 회계가 필요 없다.
