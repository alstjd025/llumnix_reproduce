...
|---|---|---|---|---|---|---|---|
| 20 | 31% | polyserve | 100.0 ±0.0 | 100.0 | 99.9 | 8,528 | 0.0 |
| | | **fluidserve** | **100.0 ±0.0** | 100.0 | 100.0 | 8,573 | 0.0 |
| 40 | 62% | polyserve | 54.4 ±0.7 | 54.4 | 79.1 | 7,277 | 0.0 |
| | | **fluidserve** | **100.0 ±0.0** | **99.9** | **100.0** | **16,546** | 0.1 |
| 60 | 94% | polyserve | 40.3 ±2.2 | 40.3 | 72.2 | 7,611 | 0.0 |
| | | **fluidserve** | **98.9 ±0.0** | **89.7** | **97.0** | **21,468** | 9.3 |
| 80 | 125% | polyserve | 33.1 ±0.1 | 33.1 | 69.3 | 8,635 | 0.0 |
| | | **fluidserve** | **87.0 ±3.0** | **60.7** | **82.1** | **18,767** | 29.6 |

**네 지표 × 네 rate 전부에서 이긴다.** offered 분모(거절을 전부 위반으로 세는 가장
불리한 채점)로도, 등가중으로도 마찬가지라 **채점 방식을 고를 여지가 없다.**
