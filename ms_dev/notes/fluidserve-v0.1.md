...
> **⚠ 이 문서는 2026-07-28의 상태이고, 현재 명세는
> [fluidserve-v0.1.1.md](fluidserve-v0.1.1.md)다 (2026-08-02).** 결정 규칙·용량 모델·
> 상수 아홉 개는 v0.1.1에서도 바뀌지 않았으므로 **§2~§6은 여전히 정본**이다. 바뀐 것은
> 정책이 읽는 길이 프로파일과 계측이고, 아래 §7의 실측 표는 그 이전 값이다.
>
...
**켠 것 62.2 대 끈 것 62.7, 편차 ±0.2 대 ±0.9**로 차이가 없다. 근거였던 편차
